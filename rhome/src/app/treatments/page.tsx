...
export const metadata: Metadata = {
  title: "Treatments",
  description:
    "Explore Rhome's treatment categories — hair loss, skincare, sexual health, weight management, mental health, and primary care.",
};
          ...
          {treatments.map((t) => (
            ...
            >
              <div>
                ...
                <h2 className="font-display mt-5 text-xl text-rhome-900">
                  {t.name}
                </h2>
                <p className="mt-2 text-sm text-rhome-700">{t.description}</p>
              </div>
