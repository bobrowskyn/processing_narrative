...
export const metadata: Metadata = {
  title: "FAQ",
  description: "Answers to common questions about how Rhone works.",
};

const general = [
  {
    q: "Is Rhone a replacement for my regular doctor?",
    a: "No. Rhone is best for focused, ongoing concerns and everyday care. We recommend keeping a primary care relationship for annual physicals and complex or emergency needs.",
  },
  {
    q: "Which states does Rhone operate in?",
    a: "Rhone's clinician network covers all 50 states, though availability of specific treatments can vary by state regulation.",
  },
  {
